...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
      ...
      :eni "C-h"   #'evil-window-left
      :eni "C-j"   #'evil-window-down
      :eni "C-k"   #'evil-window-up
      :eni "C-l"   #'evil-window-right
      ...
      ;; adds evil keybindings to dired
      (:after dired
        :map dired-mode-map
        "SPC" nil
        :n "j" #'evil-next-line
      ...
      ;; adds evil keybindings to paredit(clojure editing)
      (:after cider
        :map paredit-mode-map
        :i "C-l" #'paredit-forward-slurp-sexp
        :i "C-h" #'paredit-forward-barf-sexp
        :i "C-S-l" #'paredit-backward-barf-sexp
        :i "C-S-h" #'paredit-backward-slurp-sexp)
...
(map! :leader
      ...
      :desc "Bury buffer"             :n "TAB" #'bury-buffer
      ...
      (:desc "code" :prefix "c"
        ...
        :desc "toggle comment line"       :nv "l" #'comment-line
        :desc "Open REPL"                 :n  "r" #'+eval/open-repl
                                          :v  "r" #'+eval:repl)


        (:when (featurep! :lang clojure)
          :desc "Clojure" :prefix "m"
          :desc "Wrap"            :n "w" #'paredit-wrap-round
          :desc "Slurp Forward"   :n "l" #'paredit-forward-slurp-sexp
          :desc "Barf Backwards"  :n "h" #'paredit-forward-barf-sexp
          :desc "Barf Forwards"   :n "L" #'paredit-backward-barf-sexp
          :desc "Slurp Backwards" :n "H" #'paredit-backward-slurp-sexp)

      (:desc "file" :prefix "f"
        :desc "Find file"                 :n "f" #'find-file
        :desc "Save current file"         :n "s" #'save-buffer
